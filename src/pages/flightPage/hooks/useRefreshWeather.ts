...
const apiClient = new APIClient<PostRfreshWeather, RefreshWeatherDataFromAPI>(
  '/reports',
);
              ...
              departure_weather: savedData.takeoffWeather
                ? {
                    ...
                    wind_direction: savedData.takeoffWeather.wind_direction
                      ...
                      : null,
                    wind_magnitude_knot:
                      savedData.takeoffWeather.wind_magnitude_knot,
                  }
                : { ...currentData.departure_weather },
              legs: currentData.legs.map((leg, idx) => {
                return savedData.enrouteWeather
                  ? {
                      ...leg,
                      temperature_c:
                        savedData.enrouteWeather[idx].temperature_c,
                      altimeter_inhg:
                        savedData.enrouteWeather[idx].altimeter_inhg,
                      wind_direction:
                        savedData.enrouteWeather[idx].wind_direction !==
                        undefined
                          ? (savedData.enrouteWeather[idx]
                              .wind_direction as number)
                          : null,
                      wind_magnitude_knot:
                        savedData.enrouteWeather[idx].wind_magnitude_knot,
                    }
                  : { ...leg };
              }),
              arrival_weather: savedData.landingWeather
                ? {
                    ...
                    wind_direction: savedData.landingWeather.wind_direction
                      ...
                      : null,
                    wind_magnitude_knot:
                      savedData.landingWeather.wind_magnitude_knot,
                  }
                : { ...currentData.arrival_weather },
