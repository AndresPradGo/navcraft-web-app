...
const DeleteSurfaceAdjustmentValueForm = ({
  closeModal,
  surface,
  surfaceId,
  profileId,
  ...
  const mutation = useDeleteSurfaceAdjustmentValue(profileId, isTakeoff);

  const handleDelete = () => {
    closeModal();
    mutation.mutate(surfaceId);
  };
  ...
  return (
    <HtmlContainer>
      <h1>
        <div>
          <TitleIcon />
          Delete Runway Surface Adjustment Percentage
        </div>
...
export default DeleteSurfaceAdjustmentValueForm;
