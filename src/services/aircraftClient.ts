...
export interface CompletePerformanceProfileDataFromAPI
  extends PerformanceProfileBaseData {
...
const apiClient = new APIClient<AircraftDataFromForm, AircraftDataFromAPI>(
  '/aircraft',
);
